...
Route.get('/', () => {
  return { greeting: 'Bienvenido Focus Time' }
})
...
Route.group(() => {
  ...
  Route.patch('project/tasks/:id', 'TaskController.update').middleware('auth')
  Route.delete('project/tasks/:id', 'TaskController.destroy').middleware('auth')
